...
class Scale(ABC):
    def __init__(self, min_value: float, max_value: float, limit_min_value: float, limit_max_value: float, unit: str, scaled_min_value: float=0, scaled_max_value: float=1, type: str="lin"):
        """
